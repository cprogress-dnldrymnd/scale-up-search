...
class Ogeko_Call_To_Action extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Ogeko Banner', 'ogeko' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Image Resolution', 'ogeko' ),
                'default' => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label' => esc_html__( 'Graphic Element', 'ogeko' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'ogeko' ),
                        'icon' => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'ogeko' ),
                        'icon' => 'fa fa-picture-o',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'ogeko' ),
                        'icon' => 'eicon-star',
                    ],
                ],
                'default' => 'none',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'stacked' => esc_html__( 'Stacked', 'ogeko' ),
                    'framed' => esc_html__( 'Framed', 'ogeko' ),
                ],
                'default' => 'default',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => esc_html__( 'Shape', 'ogeko' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'circle' => esc_html__( 'Circle', 'ogeko' ),
                    'square' => esc_html__( 'Square', 'ogeko' ),
                ],
                'default' => 'circle',
                'condition' => [
                    'icon_view!' => 'default',
        ...
        $this->add_control(
            'link_click',
            [
                'label' => esc_html__( 'Apply Link On', 'ogeko' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => esc_html__( 'Whole Box', 'ogeko' ),
                    'button' => esc_html__( 'Button Only', 'ogeko' ),
                ],
                'default' => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label' => esc_html__( 'Stretch', 'ogeko' ),
        ...
        $this->add_control(
            'show_bg',
            [
                'label'     => esc_html__( 'Show Bg gradien', 'ogeko' ),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_control(
            'graphic_image_hover',
            [
                'label' => esc_html__( 'Image Effect', 'ogeko' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'icon_primary_color',
            [
                'label' => esc_html__( 'Primary Color', 'ogeko' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-cta .elementor-view-stacked .elementor-icon' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .elementor-cta .elementor-view-stacked .elementor-icon svg' => 'stroke: {{VALUE}}',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secondary Color', 'ogeko' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'icon_view!' => 'default',
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-cta .elementor-view-stacked .elementor-icon' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-cta .elementor-view-stacked .elementor-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}:hover .elementor-view-framed .elementor-icon, {{WRAPPER}}:hover .elementor-view-default .elementor-icon' => 'color: {{VALUE}}; border-color: {{VALUE}}',
                    '{{WRAPPER}}:hover .elementor-view-framed .elementor-icon, {{WRAPPER}}:hover .elementor-view-default .elementor-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}:hover .elementor-view-framed .elementor-icon' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}}:hover .elementor-view-framed .elementor-icon svg' => 'stroke: {{VALUE}};',
                    '{{WRAPPER}} .elementor-cta:hover .elementor-view-stacked .elementor-icon' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-cta:hover .elementor-view-stacked .elementor-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'icon_padding',
            [
                'label' => esc_html__( 'Icon Padding', 'ogeko' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            'icon_border_width',
            [
                'label' => esc_html__( 'Border Width', 'ogeko' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label' => esc_html__( 'Horizontal Align', 'ogeko' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => esc_html__( 'Left', 'ogeko' ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Subtitle', 'ogeko' ),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Hover', 'ogeko' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label' => esc_html__( 'Sub title Color', 'ogeko' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label' => esc_html__( 'Description Color', 'ogeko' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color', 'ogeko'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_style_theme',
            [
                'label'        => esc_html__('Button Style', 'ogeko'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__( 'Hover Effects', 'ogeko' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'overlay_color',
            [
                'label' => esc_html__( 'Overlay Color', 'ogeko' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
//        $content_animation = $settings['content_animation'];
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . ogeko_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-ogeko-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo ogeko_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo ogeko_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo ogeko_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo ogeko_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo ogeko_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <span><?php printf('%s', $settings['subtitle']); ?></span>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . ogeko_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo ogeko_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . ogeko_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
...
$widgets_manager->register(new Ogeko_Call_To_Action());
