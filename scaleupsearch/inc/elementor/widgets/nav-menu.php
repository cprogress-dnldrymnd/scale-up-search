...
class Ogeko_Elementor_Nav_Menu extends Elementor\Widget_Base {

    protected $nav_menu_index = 1;

    public function get_name() {
        return 'ogeko-nav-menu';
    }

    public function get_title() {
        return esc_html__('Ogeko Nav Menu', 'ogeko');
    }
    ...
    protected function register_controls() {
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label'        => esc_html__('Menu', 'ogeko'),
                    'type'         => Controls_Manager::SELECT,
                    'options'      => $menus,
                    'default'      => array_keys($menus)[0],
                    'save_default' => true,
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'ogeko'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => '<strong>' . esc_html__('There are no menus in your site.', 'ogeko') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'ogeko'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator'       => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography Menu', 'ogeko'),
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Typography Sub Menu', 'ogeko'),
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label'     => esc_html__('Color Menu', 'ogeko'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Sub Menu', 'ogeko'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label'     => esc_html__('Background Dropdown', 'ogeko'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
         ...
         $this->add_control(
                ...
                [
                    ...
                    'default'   => '',
                    'selectors' => [
                        '{{WRAPPER}} .main-navigation ul.menu > li.menu-item-has-children > a:after' => 'color: {{VALUE}};',
                    ],
                ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Item', 'ogeko'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
    ...
    protected function render() {
        ...
        <div <?php echo ogeko_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <nav class="main-navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'ogeko'); ?>">
...
$widgets_manager->register(new Ogeko_Elementor_Nav_Menu());
