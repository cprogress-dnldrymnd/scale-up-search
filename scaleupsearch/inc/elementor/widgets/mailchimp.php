...
if (!ogeko_is_mailchimp_activated()) {
    return;
}
...
class Ogeko_Elementor_Mailchimp extends Elementor\Widget_Base {

    public function get_name() {
        return 'ogeko-mailchmip';
    }

    public function get_title() {
        return esc_html__('MailChimp Sign-Up Form', 'ogeko');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Placeholder', 'ogeko'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color hover', 'ogeko'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Ogeko_Elementor_Mailchimp());
