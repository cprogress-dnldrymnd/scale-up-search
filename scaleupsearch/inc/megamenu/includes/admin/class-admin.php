...
class Ogeko_Admin_MegaMenu {
    ...
    public function process_create_related($post_id) {
        if (isset($_GET['ogeko-menu-createable']) && isset($_GET['menu_id']) && absint($_GET['menu_id'])) {
            ...
            if ($related_id && isset($_REQUEST['menu_id']) && is_admin()) {
                ...
                $action = add_query_arg(array('ogeko-menu-editable' => 1), $url);
