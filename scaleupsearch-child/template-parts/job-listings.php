                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading<?= get_the_ID() . '-description' ?>">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse<?= get_the_ID() . '-description' ?>"
                                            aria-expanded="<?= $key == 0 ? 'true' : 'false' ?>"
                                            aria-controls="collapse<?= get_the_ID() . '-description' ?>">
                                            <svg class="fa-plus" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                                <path
                                                    d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                                            </svg>
                                            <svg class="fa-minus" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div id="collapse<?= get_the_ID() . '-description' ?>"
                                        class="accordion-collapse collapse <?= $key == 0 ? 'show ' : '' ?>"
                                        aria-labelledby="heading<?= get_the_ID() . '-description' ?>"
                                        data-bs-parent="#accordion-Careers">
                                        <div class="accordion-body">
                                            ...
                                            <div class="elementor-button-wrapper">
                                                <a href="#"
                                                    class="apply-button elementor-button-link elementor-button elementor-size-sm"
                                                    role="button" data-title="<?php the_title() ?>"
                                                     data-bs-toggle="modal"
                                                    data-bs-target="#applyModal-<?= get_the_ID() ?>">
                                                    <span class="elementor-button-content-wrapper">
                                                        <span class="elementor-button-icon left">
                                                            <i aria-hidden="true"
                                                                class="ogeko-icon- ogeko-icon-arrow-right"></i> </span>
...
while (have_posts()) {
    ...
    <!-- Modal -->
    <div class="modal right fade" id="applyModal-<?= get_the_ID() ?>" tabindex="-1" aria-labelledby="applyModalLabel"
        aria-hidden="true">
